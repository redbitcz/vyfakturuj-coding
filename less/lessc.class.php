    ...
    protected function compileProp($prop,$block,$out){
        ...
        switch($prop[0]){
            ...
            case "import";
                ...
                // MD: 201606-22: pokud nenajdeme scss soubor, tak ho neimportujeme a ani nezanechame @import (mohlo by zlobit u @import *.css ktere bychom fakt chteli)
                if($result !== false){
                    $this->env->imports[$importId] = $result;
                }
